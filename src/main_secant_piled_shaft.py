...
def main_secant_piled_shaft(st):
    ...
    H_drilling_platform = col1.number_input('Height of drilling platform above top of piles [m]', value=parameters['H_drilling_platform'], step=1.0, min_value=0.0, max_value=20.0, key='H_drilling_platform')
